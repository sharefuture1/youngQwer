...
项目的进展与未来计划在 [Issue](https://github.com/Kaiyiwing/qwerty-learner/issues/42) 中详细介绍，内部也包含对未来功能的意见征询等，如果对 QWER 的未来感兴趣，欢迎参与讨论。
...
非常感谢大家使用 QWER, 目前该网站由三个人用业余时间在维护，我们希望在未来购买独立的域名(目前使用 vercel 部署)，并购买服务器以方便国内用户访问与云同步存储数据。
